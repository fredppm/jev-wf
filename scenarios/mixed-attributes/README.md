...
[jev] item1: checks escalate_for_manual_review=no (0.03), fraud_check=no (0.05)
[jev] item1: options=[cancel_item, defer_item, mark_item_digital_only, reserve_item_stock] -> reserve_item_stock (confidence 1.00)
set_shipping_method(item1, refrigerated_express)
reserve_item_stock(item1, origin=cold-dc-sp, qty=1)
start_fulfillment(item1)
[jev] item2: checks escalate_for_manual_review=no (0.04), fraud_check=no (0.05), request_blocking_requirement_validation=yes (0.97)
request_blocking_requirement_validation(item2) -> approved
[jev] item2: checks escalate_for_manual_review=no (0.03), fraud_check=no (0.05)
[jev] item2: options=[cancel_item, defer_item, mark_item_digital_only, reserve_item_stock] -> reserve_item_stock (confidence 1.00)
set_shipping_method(item2, standard)
reserve_item_stock(item2, origin=central-pharmacy-sp, qty=1)
start_fulfillment(item2)
[jev] item3: checks escalate_for_manual_review=no (0.03), fraud_check=no (0.05)
[jev] item3: options=[cancel_item, defer_item, mark_item_digital_only, reserve_item_stock] -> mark_item_digital_only (confidence 1.00)
mark_item_digital_only(item3)
complete_item(item3)
[jev] item4: checks escalate_for_manual_review=no (0.03), fraud_check=no (0.06)
[jev] item4: options=[cancel_item, defer_item, mark_item_digital_only, reserve_item_stock] -> reserve_item_stock (confidence 1.00)
set_shipping_method(item4, standard)
reserve_item_stock(item4, origin=regional-dc-sp, qty=1)
start_fulfillment(item4)
[jev] item5: checks escalate_for_manual_review=no (0.03), fraud_check=no (0.07)
[jev] item5: options=[cancel_item, defer_item, mark_item_digital_only, reserve_item_stock] -> defer_item (confidence 1.00)
defer_item(item5, "payment approved by seller-collectibles")
